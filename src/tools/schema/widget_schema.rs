...
pub struct WidgetSchema {
    pub(crate) widget_type: &'static str,
    pub(crate) category: &'static str,
    /// Known valid setting keys for this widget.
    pub(crate) settings: &'static [&'static str],
...
pub(crate) const COMMON_SETTINGS: &[&str] = &[
    // Layout
...
pub(crate) const TYPOGRAPHY_KEYS: &[&str] = &[
...
pub(crate) fn all_schemas() -> Vec<WidgetSchema> {
    vec![
        WidgetSchema {
            widget_type: "heading",
            category: "basic",
